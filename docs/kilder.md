...
Disse kildene underbygger begrepsforklaringene i guiden:

- [VirtualBox: nedlastinger](https://www.virtualbox.org/wiki/Downloads)
- [Oracle VirtualBox: virtuelle nettverk og innebygd DHCP](https://docs.oracle.com/en/virtualization/virtualbox/7.2/user/networkingdetails.html)
- [Microsoft: DHCP og automatisk tildeling av IP-adresser](https://learn.microsoft.com/en-us/troubleshoot/windows-server/networking/troubleshoot-dhcp-guidance)
...
- [Microsoft: sikkerhetsgrupper i Active Directory](https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/understand-security-groups)
